                                            ...
                                            if(id!=null){
                                                if(lx=='1'){
                                                    ...
                                                    layui.layer.open({
                                                        ...
                                                        content:$("#exportTask").html()
                                                    });
                                                    var timer = null,
                                                        ajaxProcess =null;
                                                    //500毫秒轮询一次
                                                    timer = setInterval(function(){
                                                        //ajaxProcess && ajaxProcess.abort();
                                                        ajaxProcess =  $.ajax({
                                                            url:"/vereport/rest/reporttask/getRw?time="+new Date().getTime(),
                                                            data:{'id':id},
                                                            type : 'POST',
                                                            success:function(data){
                                                                ...
                                                                if(data['result']['zt']==3){
                                                                    clearInterval(timer);
                                                                    console.log(data);
                                                                    $("#taskContainer").html($("#exportSuccess").html());
                                                                    $("#taskContainer").find("a").attr("href","/vereport/rest/reporttask/download?id="+id);
                                                                }
                                                            }
